...
$stats_type = array(
    ...
    "player" => array(
        ...
        "YinYang" => array("id"=> 17,
            "name" => totranslate("Number of points gains with Yin-Yang symbol (Module A)"),
            "type" => "int" ),
        
        "Objectives" => array("id"=> 18,
            "name" => totranslate("Number of points gains with objectives (Module D)"),
            "type" => "int" ),

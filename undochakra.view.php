 ...
 * particular, you can set here the values of variables elements defined in undochakra_undochakra.tpl (elements
 ...
 */
  ...
  class view_undochakra_undochakra extends game_view
  {
    function getGameName() {
  	...
  	{		
        ...
        $this->page->begin_block("undochakra_undochakra", "player");

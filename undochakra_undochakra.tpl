...
var jstpl_player_board = '<div class="cp_board" id="cp_board_${id}"></div>';
var jstpl_objective = '<div class="objective" id="objective_${type}"></div>';
var jstpl_obj_points = '<div class="objective_points" id="objective_${id}_${points}"></div>';
var jstpl_energy = '<div class="energy ${color}" id="energy_${id}"></div>';
var jstpl_yinyangfull = '<div class="yinyang yingyangfull" id="y_${id}"></div>';
var jstpl_yinyanghalf = '<div class="yinyang yingyanghalf" id="y_${id}"></div>';
